					...
					<Accordion.Item className="accordion-item">
						...
						<Accordion.Content className="accordion-item-content" id="experience">
							<article>
								...
								<p>We are in the business of planning higly invidualized vacation trips for more than 20 years</p>
							</article>
						</Accordion.Content>
					</Accordion.Item>
					<Accordion.Item className="accordion-item">
						...
						<Accordion.Content className="accordion-item-content" id="local-guides">
							<article>
								...
								<p>
									Instead, Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, ut! Quod perspiciatis sequi
									eligendi ea voluptas dolor! Enim, tenetur delectus.
								</p>
							</article>
						</Accordion.Content>
					</Accordion.Item>
